<?php
	...
	* GitHub Plugin URI: https://github.com/asha23/bl-prevent-acf-timeouts
	* Primary Branch: main
	* Release Asset: true
	**/
...
<html xmlns="http://www.w3.org/1999/xhtml" <?php
	...
	<body id="error-page">
		<div class="heading">
			<div class="m-left">
				<img src="<?= plugin_dir_url( __FILE__ ); ?>img/globey-pointer.svg" style="width:100%;height: auto;">
			</div>
			<div class="m-right">
				<h1><?php
					$text = 'Your page is being processed';
					echo apply_filters('acf/prevent-timeout/timeout-page/heading', $text, $this->post_id); ?></h1>
				<p class="message">
					<?php
						$text = 'It is taking slightly longer than usual to publish your page.';
				...
				<p class="note">
					<?php
						$text = '<h5 style="color:red;">This isn\'t an error</h5>'.
										'<p>Please don\'t close this page, you will be redirected back to what you were doing as soon as the page is fully published. This shouldn\'t take more than a minute.</p>';
